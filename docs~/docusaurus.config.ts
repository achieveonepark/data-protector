...
const repositoryUrl = 'https://github.com/achieveonepark/data-protector';

const config: Config = {
  title: 'Data Protector',
  tagline: 'Data Protector documentation',
  favicon: 'favicon.svg',

  // GitHub Pages — url/baseUrl 은 통합 빌드(CI)가 덮어쓴다.
  url: 'https://achieveonepark.github.io',
  baseUrl: '/data-protector/',
  organizationName: 'achieveonepark',
  projectName: 'data-protector',
  ...
  themeConfig: {
    ...
    footer: {
      style: 'dark',
      links: [],
      copyright: 'MIT License · Copyright © Data Protector',
    },
    prism: {
